...
const styles = {
  ...
  card: { background: "var(--card-bg)", padding: "24px", borderRadius: "16px", border: "1px solid var(--border-color)", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.1)" },
  cardTitle: { fontSize: "18px", color: "var(--text-primary)", margin: 0 },
  formContainer: { display: "flex", flexDirection: "column", gap: "18px", marginTop: "20px" },
  inputGroup: { display: "flex", flexDirection: "column", gap: "8px" },
  label: { fontSize: "12px", color: "var(--text-secondary)", fontWeight: "600", textTransform: "uppercase" },
  input: { background: "var(--bg-primary)", border: "1px solid var(--border-color)", color: "var(--text-primary)", padding: "12px", borderRadius: "10px", outline: "none" },
  createBtn: { background: "var(--accent-blue)", color: "#fff", padding: "12px", border: "none", borderRadius: "10px", fontWeight: "700", cursor: "pointer", transition: "0.2s" },
  listHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" },
  searchBar: { background: "var(--bg-primary)", border: "1px solid var(--border-color)", color: "var(--text-primary)", padding: "8px 15px", borderRadius: "20px", fontSize: "13px", width: "200px" },
  scrollArea: { maxHeight: "60vh", overflowY: "auto", paddingRight: "5px" },
  staffRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "15px", background: "var(--bg-primary)", borderRadius: "12px", marginBottom: "10px", border: "1px solid var(--border-color)" },
  staffInfo: { display: "flex", alignItems: "center", gap: "12px" },
  avatar: { width: "40px", height: "40px", borderRadius: "50%", background: "var(--bg-tertiary)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--accent-blue)", fontWeight: "700", border: "1px solid var(--border-color)" },
  staffName: { fontSize: "15px", color: "var(--text-primary)" },
  staffEmail: { fontSize: "13px", color: "var(--text-secondary)" },
  ...
  emptyText: { textAlign: "center", color: "var(--text-secondary)", marginTop: "20px" }
};
